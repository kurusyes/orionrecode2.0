# Orion Library
This documentation is for the stable release of Orion Recode 2.0 For oreol.xyz Library.

## Booting the Library
```lua
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/kurusyes/orionrecode2.0/main/orionrecode2.0.luau')))()
```
